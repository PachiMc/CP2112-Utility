...
from .paths import dll_search_dirs

# Load the SLAB HID->SMBus DLL (bundled in frozen builds or in vendor/).
_DLL_NAME = 'SLABHIDtoSMBus.dll'
_dll = None
_dll_error = None
if os.name == 'nt':
    last_exc = None
    for directory in dll_search_dirs():
        dll_path = directory / _DLL_NAME
